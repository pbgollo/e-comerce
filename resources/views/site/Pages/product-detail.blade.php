...
@section('js')
    <script src="{{ asset(mix('/assets/site/js/pages/product.js')) }}"></script>
@endsection
...
@section('content')
    <section class="details-wrapper">
        <div class="details js-product" data-id = "{{ $product['id'] }}">
                    ...
                    <div class = "details__item__right__actions">
                        ...
                        <div class = "details__item__right__actions__texts">
                            ...
                            <div class = "details__item__right__actions__texts__right">
                                {{-- <a href="{{ $product['stock']['quantity'] > 0 ? url('/cart') : 'javascript:void(0);' }}"
                                    class="details__item__right__actions__texts__right__buy js-buy-button {{ $product['stock']['quantity'] > 0 ? '' : 'disabled' }}">
                                ...
                                <a class = "details__item__right__actions__texts__right__cart js-add-to-cart-button {{ $product['stock']['quantity'] > 0 ? '' : 'disabled' }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                {{-- <a href="{{ $product['stock']['quantity'] > 0 ? url('/cart') : 'javascript:void(0);' }}"
                                    class = "details__item__right__actions__texts__right__cart js-add-to-cart-button {{ $product['stock']['quantity'] > 0 ? '' : 'disabled' }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="https://www.w3.org/2000/svg" class="IconAddToCart">
                                        <path
                                            d="M17.5 18.78V17.04H6.2C6.06 17 5.96 16.89 5.96 16.75L5.99 16.63L6.87 14.43H14.85C15.56 14.43 16.18 14.03 16.5 13.43L17.38 11.8C14.53 11.12 12.35 8.71 12.03 5.73H4.12L3.2 4H0V5.74H1.94L5.44 13.36L4.13 15.82C3.9 16.23 3.82 16.75 3.95 17.28C4.17 18.19 5.03 18.79 5.94 18.79H17.5V18.78Z"
